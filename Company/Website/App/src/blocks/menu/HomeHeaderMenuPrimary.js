                ...
                <nav className="menu-primary">
                    <ul className="nav">
                        ...
                        <li id="nav-teams" className="nav-item">
                            <Link onClick={ ( e ) => this.handleClick( e ) } title="Teams" to="team-members" href="#team-members">Team</Link>
                        </li>
                        ...
                        <li id="nav-testimonials" className="nav-item">
                            <Link onClick={ ( e ) => this.handleClick( e ) } title="Testimonials" to="testimonials" href="#testimonials">Testimonials</Link>
                        </li>
