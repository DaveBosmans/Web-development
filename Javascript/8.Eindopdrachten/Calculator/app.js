...
//     let buttonInput =+ parseFloat(pressed.innerHTML).toFixed(2);
//     let buttonInputSigns = pressed.innerHTML;
//     console.log(pressed.innerHTML);
//     console.log(buttonInput);
//     console.log("datatype " + typeof (buttonInput));

//     if (buttonInputSigns.innerHTML == '=') {
//         outputScreen.innerHTML = Number(eval(outputScreen.innerHTML));
     
//     } else if (buttonInputSigns == 'AC') {
//         outputScreen.innerHTML = '';
//     } else if (buttonInputSigns == '+/-') {
...
function inputButtons(pressed) {
    ...
    if (buttonInput == '/' || buttonInput == '*' || buttonInput == '+' || buttonInput == '-' || buttonInput == '=') {
